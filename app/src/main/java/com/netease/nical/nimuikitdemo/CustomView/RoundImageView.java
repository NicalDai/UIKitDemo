package com.netease.nical.nimuikitdemo.CustomView;
...
public class RoundImageView extends AppCompatImageView {
     ...
     * 默认的圆角大小，单位为dp
     */
    private static final float DEFAULT_CORNER = 5;
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mCorner = (int) typedArray.getDimension(R.styleable.RoundImageView_corner, dp2px(context, DEFAULT_CORNER));
        typedArray.recycle();
    }
